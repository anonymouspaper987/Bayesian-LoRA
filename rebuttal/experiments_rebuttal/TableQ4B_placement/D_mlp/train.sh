#!/bin/bash
# Table Q4-B: Adapter placement D (MLP) - gate_proj,up_proj,down_proj,lm_head
set -e
...
echo "[$(date)] === Training Bayesian_LoRA placement D ===" | tee "$TRAIN_LOG"

python rebuttal/train_classification.py \
    --method Bayesian_LoRA \
    --dataset ARC-Easy \
    --model_name_or_path Qwen/Qwen3-14B \
    --output_dir /home/anonymous/rebuttal/Bayesian_lora_peft/rebuttal/outputs/rebuttal/TableQ4B/D_mlp \
