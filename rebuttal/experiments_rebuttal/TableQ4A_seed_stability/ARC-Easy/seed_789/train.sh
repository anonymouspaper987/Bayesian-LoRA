#!/bin/bash
# Table Q4-A: Bayesian-LoRA seed stability - ARC-Easy seed=789
set -e
...
echo "[$(date)] === Training Bayesian_LoRA on ARC-Easy (seed=789) ===" | tee "$TRAIN_LOG"

python rebuttal/train_classification.py \
    --method Bayesian_LoRA \
    --dataset ARC-Easy \
    --model_name_or_path Qwen/Qwen3-14B \
    --output_dir /home/anonymous/rebuttal/Bayesian_lora_peft/rebuttal/outputs/TableQ4A/ARC-Easy/seed_789 \
