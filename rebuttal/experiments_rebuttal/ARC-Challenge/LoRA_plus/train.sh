#!/bin/bash
# Train LoRA_plus on ARC-Challenge (Qwen3-14B, seed=42)
set -e
...
python rebuttal/train_classification.py \
    ...
    --output_dir /home/anonymous/rebuttal/Bayesian_lora_peft/rebuttal/outputs/rebuttal/ARC-Challenge/LoRA_plus \
