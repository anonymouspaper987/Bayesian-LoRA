#!/bin/bash
# Train LoRA on ARC-Easy (Llama-3.1-8B, seed=42)
set -e
...
echo "[$(date)] === Training LoRA on ARC-Easy ===" | tee "$TRAIN_LOG"

python rebuttal/train_classification.py \
    --method LoRA \
    --dataset ARC-Easy \
    --model_name_or_path meta-llama/Llama-3.1-8B \
    --output_dir /anvil/scratch/x-qlan1/moule/rebuttal/Bayesian_lora_peft/outputs/Llama3/ARC-Easy/LoRA \
