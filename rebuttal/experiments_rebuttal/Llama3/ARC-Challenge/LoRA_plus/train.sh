#!/bin/bash
# Train LoRA_plus on ARC-Challenge (Llama-3.1-8B, seed=42)
set -e
...
echo "[$(date)] === Training LoRA_plus on ARC-Challenge ===" | tee "$TRAIN_LOG"

python rebuttal/train_classification.py \
    --method LoRA_plus \
    --dataset ARC-Challenge \
    --model_name_or_path meta-llama/Llama-3.1-8B \
    --output_dir /anvil/scratch/x-qlan1/moule/rebuttal/Bayesian_lora_peft/outputs/Llama3/ARC-Challenge/LoRA_plus \
