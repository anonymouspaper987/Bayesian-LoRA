#!/bin/bash
# Train AdaLoRA on ARC-Challenge (Llama-3.1-8B, seed=42)
set -e
...
echo "[$(date)] === Training AdaLoRA on ARC-Challenge ===" | tee "$TRAIN_LOG"

python rebuttal/train_classification.py \
    --method AdaLoRA \
    --dataset ARC-Challenge \
    --model_name_or_path meta-llama/Llama-3.1-8B \
    --output_dir /anvil/scratch/x-qlan1/moule/rebuttal/Bayesian_lora_peft/outputs/Llama3/ARC-Challenge/AdaLoRA \
