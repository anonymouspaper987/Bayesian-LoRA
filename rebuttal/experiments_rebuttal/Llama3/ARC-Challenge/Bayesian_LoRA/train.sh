#!/bin/bash
# Train Bayesian_LoRA on ARC-Challenge (Llama-3.1-8B, seed=42)
set -e
...
python rebuttal/train_classification.py \
    ...
    --output_dir /anvil/scratch/x-qlan1/moule/rebuttal/Bayesian_lora_peft/outputs/Llama3/ARC-Challenge/Bayesian_LoRA \
