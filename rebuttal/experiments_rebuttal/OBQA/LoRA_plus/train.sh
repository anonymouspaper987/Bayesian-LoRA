#!/bin/bash
# Train LoRA_plus on OBQA (Qwen3-14B, seed=42)
set -e
...
echo "[$(date)] === Training LoRA_plus on OBQA ===" | tee "$TRAIN_LOG"

python rebuttal/train_classification.py \
    --method LoRA_plus \
    --dataset OBQA \
    --model_name_or_path Qwen/Qwen3-14B \
    --output_dir /home/anonymous/rebuttal/Bayesian_lora_peft/rebuttal/outputs/rebuttal/OBQA/LoRA_plus \
