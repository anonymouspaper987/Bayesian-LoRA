#!/bin/bash
# Train Bayesian_LoRA on OBQA (Qwen3-14B, seed=42)
set -e
...
echo "[$(date)] === Training Bayesian_LoRA on OBQA ===" | tee "$TRAIN_LOG"

python rebuttal/train_classification.py \
    --method Bayesian_LoRA \
    --dataset OBQA \
    --model_name_or_path Qwen/Qwen3-14B \
    --output_dir /home/anonymous/rebuttal/Bayesian_lora_peft/rebuttal/outputs/rebuttal/OBQA/Bayesian_LoRA \
