#!/bin/bash
# Eval Bayesian-LoRA ARC-Easy inducing dim ablation: rows=4 cols=9
set -e
...
echo "[$(date)] === Evaluating rows=4 cols=9 (n_mc=4) ===" | tee "$EVAL_LOG"

python rebuttal/eval_classification.py \
    --method Bayesian_LoRA \
    --dataset ARC-Easy \
    --model_name_or_path Qwen/Qwen3-14B \
    --lora_path /home/anonymous/rebuttal/Bayesian_lora_peft/rebuttal/outputs/rc_ablation/r4_c9/final \
    --n_mc 4 \
    --inducing_rows 4 \
    --inducing_cols 9 \
    --seed 42 \
