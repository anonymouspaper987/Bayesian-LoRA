#!/bin/bash
# Bayesian-LoRA ARC-Easy inducing dim ablation: rows=9 cols=4
set -e
...
echo "[$(date)] === Training Bayesian_LoRA ARC-Easy inducing rows=9 cols=4 ===" | tee "$TRAIN_LOG"

python rebuttal/train_classification.py \
    --method Bayesian_LoRA \
    --dataset ARC-Easy \
    --model_name_or_path Qwen/Qwen3-14B \
    --output_dir /home/anonymous/rebuttal/Bayesian_lora_peft/rebuttal/outputs/rc_ablation/r9_c4 \
