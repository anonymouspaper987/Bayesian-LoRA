#!/bin/bash
# Train Bayesian_LoRA on ARC-Easy (Qwen3-14B, seed=42)
set -e
...
python rebuttal/train_classification.py \
    ...
    --output_dir /home/anonymous/rebuttal/Bayesian_lora_peft/rebuttal/outputs/rebuttal/ARC-Easy/Bayesian_LoRA \
